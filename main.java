...
class GFG2 {
	...
	public static void main(String args[])
	{
		try
		{
			...
			String s2 = "As it is written in Isaiah the prophet, Behold, I send my messenger before thy face,who shall prepare thy way";
			System.out.println("\n" + s2 + " : " + toHexString(getSHA(s2)));
			
			String s3 = " the voice of one crying in the wilderness: Prepare the way of the Lord,make his paths straight --";
...
[35] Whoever does the will of God is my brother, and sister, and mother.
    ...
    private static String extracted() {
        return "The beginning of the gospel of Jesus Christ, the Son of God.";
    }
}
